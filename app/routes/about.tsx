...
function SocialIcon({ type }: { type: "x" | "github" }) {
  if (type === "x") {
    return (
      <svg className="about-link__icon" fill="currentColor" viewBox="0 0 16 16">
  ...
  return (
    <svg className="about-link__icon" fill="currentColor" viewBox="0 0 24 24">
