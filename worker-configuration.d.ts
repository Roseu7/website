/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b3ff1bad101303f8452946fa76dcaefd)
// Runtime types generated with workerd@1.20250803.0 2025-04-04 
declare namespace Cloudflare {
	interface Env {
		VALUE_FROM_CLOUDFLARE: "Hello from Cloudflare";
		COUNTERS: DurableObjectNamespace<import("./workers/app").Counter>;
		REALTIME_COUNTERS: DurableObjectNamespace<import("./workers/app").RealtimeCounter>;
		CHAT_ROOMS: DurableObjectNamespace<import("./workers/app").ChatRoom>;
	}
}
